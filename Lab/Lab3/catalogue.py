...
class Catalogue:
    ...
    def get_book_list(self):
        ...
        :return: list of book type objects
        """
    ...
    def add_book(self):
        ...
        found_book = self.retrieve_book_by_call_number(
    ...
    def remove_book(self, call_number):
        ...
        """
        found_book = self.retrieve_book_by_call_number(call_number)
        if found_book:
    ...
    def reduce_book_count(self, call_number):
        ...
        otherwise.
        """
        library_book = self.retrieve_book_by_call_number(call_number)
        if library_book:
    ...
    def retrieve_book_by_call_number(self, call_number):
        """
        Retrieve of a book with the given call number from the catalogue.
        :param call_number: a string
